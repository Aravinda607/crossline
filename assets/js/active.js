;(function ($) {
  ...
  $mobileSubMenuToggle.on('click', function () {
    ...
    if ($this.hasClass('active')) {
      $this
        ...
        .closest('li')
        .removeClass('active')
        .find($mobileSubMenuToggleClass)
        .removeClass('active')
        .closest('li')
        .removeClass('active')
        .find($mobileSubMenuClass)
        .slideUp()
    } else {
  ...
  const productThumbCarouselVertical = new Swiper(
  ...
  const productImageSliderVertical = new Swiper(
  ...
  const quickviewProductThumbCarousel = new Swiper(
  ...
  const quickviewProductImageSlider = new Swiper(
    '.quickview-product-image-slider',
    {
      slidesPerView: 1,
      spaceBetween: 30,
...
function getResponse(message) {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer:
        'That is a philosophical question and opinions may vary. From my perspective, I exist to assist and make your life easier.',
    },
  ]
  ...
  const questionMatch = questions.find(
...
const quickViewButtons = document.querySelectorAll(
  '.product-action-btn[data-tooltip-text="Quick View"]'
)

quickViewButtons.forEach((button) => {
  button.addEventListener('click', function () {
    const productLink = button.parentElement
